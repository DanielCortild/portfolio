...
const projects = [
  ...
  },
  {
    ...
    description: `This project uses Realtime Firebase Firestore database to store messages. The app is built using ReactJS on the front-end, using ReactFlipMove for animations.`,
